...
# SECRET_KEY = 'django-insecure-h0hc_7)(0auj5874anhtn^@ft6_#hqzno%-sm7+-z&j@_m0k=4'
...
SUPERSET_BASE_URL = os.environ.get("SUPERSET_BASE_URL", "https://superset.enlaight.ai").rstrip("/")
...
EMAIL_USE_TLS = True
EMAIL_HOST_USER = (
    "AKIA6GBMG3HYJ5QV7VHC"
)
# EMAIL_HOST_USER = os.getenv("EMAIL_HOST_USER")
# EMAIL_HOST_PASSWORD = os.getenv("EMAIL_HOST_PASSWORD")
EMAIL_HOST_PASSWORD = "BFGsV96quEl+QOkFZVeAxRauY6zZGGNq3rXBFEgGQt6O"
DEFAULT_FROM_EMAIL = "Enlaight <noreply@enlaight.ai>"
